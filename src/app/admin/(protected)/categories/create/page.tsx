...
export default function CreateCategoryPage() {
    ...
    useEffect(() => {
        const fetchParentCats = async () => {
            try {
                ...
                console.error(
                    t('categories.create.messages.load_parent_error'),
                    error
                );
            }
        };
    ...
    const handleSubmit = async (
        ...
        if (!categoryName || !imageFile) {
            toast.error(t('categories.create.messages.validation_error'));
            return;
        }
        ...
        try {
            ...
            toast.success(t('categories.create.messages.create_success'));
            router.push('/admin/categories');
        } catch (error: any) {
            console.error('Create category error:', error);
            toast.error(
                error.response?.data?.message ||
                    t('categories.create.messages.create_error')
            );
        } finally {
    ...
    const breadcrumbs = [
        ...
        { name: t('categories.create.title') },
    ];
                ...
                >
                    ...
                    <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                        <h2 className="text-xl font-semibold text-gray-800 mb-6 pb-4 border-b border-gray-200">
                            {t('categories.create.card_title')}
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                >
                                    {t('categories.create.form.name_label')}{' '}
                                ...
                                <input
                                    ...
                                    placeholder={t(
                                        'categories.create.form.name_placeholder'
                                    )}
                                    required
                                />
                            </div>
                            ...
                            >
                                <label className="form-label mb-2 block text-sm font-medium text-gray-700">
                                    {t('categories.create.form.parent_label')}
                                </label>
                                <div
                                ...
                                >
                                    ...
                                    >
                                        {selectedParent
                                            ? selectedParent.name
                                            : t(
                                                  'categories.create.form.parent_placeholder'
                                              )}
                                    </span>
                                        ...
                                        <div className="p-3 border-b border-gray-100 bg-gray-50">
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    placeholder={t(
                                                        'categories.create.form.parent_search'
                                                    )}
                                                    value={parentSearch}
                                                    onChange={(e) =>
                                                        setParentSearch(
                                        ...
                                        <ul className="max-h-60 overflow-y-auto">
                                            ...
                                            {parentCategories.length === 0 ? (
                                                <li className="px-4 py-3 text-sm text-gray-500 text-center">
                                                    {t(
                                                        'categories.create.form.parent_not_found'
                                                    )}
                                                </li>
                                            ) : (
                        ...
                        <div className="mt-6">
                            <label className="form-label mb-2 block text-sm font-medium text-gray-700">
                                {t('categories.create.form.image_label')}{' '}
                                <span className="text-red-500">*</span>
                            </label>
                            <div
                                ...
                                {imagePreview && (
                                    <div className="absolute top-2 right-2 z-30">
                                        <button
                                            ...
                                            title={t(
                                                'categories.create.image.delete_title'
                                            )}
                                        >
                        ...
                        >
                            {isSubmitting ? (
                                <>
                                    ...
                                    {t('categories.create.actions.saving')}
                                </>
                            ) : (
                                <>
