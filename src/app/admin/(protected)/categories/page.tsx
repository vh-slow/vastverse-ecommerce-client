...
export default function CategoriesPage() {
    ...
    const fetchCategories = useCallback(async () => {
        ...
        try {
            ...
            const response =
                await apiCategory.getCategoriesPaginationForAdmin(params);
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            toast.error(t('categories.messages.delete_failed'));
        } finally {
    ...
    const handleRestore = async (id: number) => {
        try {
            ...
            toast.success(t('categories.messages.restore_success'));
            fetchCategories();
        } catch (error) {
            toast.error(t('categories.messages.restore_failed'));
        }
    };
    ...
    const breadcrumbs = [
        ...
        { name: t('categories.title', { defaultValue: 'Quản lý danh mục' }) },
    ];

    return (
        <>
            <Header title={t('categories.title')} breadcrumbs={breadcrumbs} />
                                    ...
                                    categories.map((cat, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-4 text-gray-600 font-medium">
                                                {cat.parentName ? (
                                                    <span className="px-2.5 py-1 bg-blue-50 text-blue-600 rounded-md text-xs">
                                                        {cat.parentName}
                                                    </span>
                                                ) : (
