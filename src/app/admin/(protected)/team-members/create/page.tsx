...
export default function CreateTeamMemberPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!fullName.trim() || !position.trim()) {
            toast.error(t('team.create.messages.val_info_req'));
            return;
        }
        ...
        try {
            ...
            await apiTeam.createTeamMember(formData);

            toast.success(t('team.create.messages.create_success'));
            router.push('/admin/team-members');
        } catch (error: any) {
            console.error('Create team member error:', error);
            toast.error(
                error.response?.data?.message ||
                    t('team.create.messages.create_error')
            );
        } finally {
        ...
        <>
            ...
            <div className="flex-1 px-6 py-2">
                <form className="space-y-8" onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder={t(
                                        'team.create.form.fullname_placeholder'
                                    )}
                                    required
                                    autoFocus
                                />
                            ...
                            <div>
                                <label className="form-label mb-2 block text-sm font-medium text-gray-700">
                                    {t('team.create.form.position_label')}{' '}
                                    <span className="text-red-500">*</span>
                                </label>
                                <input
                                    type="text"
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
                                    placeholder={t(
                                        'team.create.form.position_placeholder'
                                    )}
                                    required
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 md:col-span-2">
                                <div>
                                    <label className="form-label mb-2 block text-sm font-medium text-gray-700">
                                        {t('team.create.form.status_label')}
                                    </label>
                                    <select
                                        value={isActive}
                                        onChange={(e) =>
                                ...
                                <div>
                                    <label className="form-label mb-2 block text-sm font-medium text-gray-700">
                                        {t('team.create.form.order_label')}
                                    </label>
                                    <input
                                        type="number"
                                        min="0"
                                        ...
                                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
                                        placeholder={t(
                                            'team.create.form.order_placeholder'
                                        )}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition"
                                    placeholder={t(
                                        'team.create.form.bio_placeholder'
                                    )}
                                ></textarea>
                            </div>
                        </div>
                    ...
                    <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
                        <h2 className="text-base font-semibold text-gray-800 mb-6 pb-4 border-b border-gray-200">
                            {t('team.create.card_media')}
                        </h2>

                        <div>
                            <label className="form-label mb-2 block text-sm font-medium text-gray-700">
                                {t('team.create.form.avatar_label')}
                            </label>
